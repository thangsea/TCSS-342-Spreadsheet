package edu.uw.tacoma.thangvn.webserviceslab;
...
import edu.uw.tacoma.thangvn.webserviceslab.CourseFragment.OnListFragmentInteractionListener;
import edu.uw.tacoma.thangvn.webserviceslab.course.Course;

//import edu.uw.tacoma.thangvn.webserviceslab.ItemFragment.OnListFragmentInteractionListener;
//import edu.uw.tacoma.thangvn.webserviceslab.course.Course.Course;
...
public class MyCourseRecyclerViewAdapter extends RecyclerView.Adapter<MyCourseRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Log.i("Adapter", mValues.size() + " size");
