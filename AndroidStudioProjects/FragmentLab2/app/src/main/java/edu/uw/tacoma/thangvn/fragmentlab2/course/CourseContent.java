package edu.uw.tacoma.thangvn.fragmentlab2.course;
...
public class CourseContent {
    ...
    /**
     * A course item representing a piece of title.
     */
    public static class CourseItem implements Serializable{
        ...
        public CourseItem(String id, String theTitle, String theDescription) {
            this.id = id;
            this.title = theTitle;
            this.shortDescription = theDescription;
        }
